...
namespace LVLgroupApp.Areas.Identity.Pages.Account.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string GetUserId(ViewContext viewContext)
        {
            if (viewContext.ModelState["userId"] == null)
            {
                var inputId = viewContext.ModelState["Input.Id"].RawValue.ToString();
                return inputId;
            }
            var userId = viewContext.ModelState["userId"].RawValue.ToString();
            return userId;
        }
