...
{
    /// <inheritdoc />
    public partial class LVL_ReportMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReportAnswer_QuestionTemplates_QuestionTemplateId",
                        column: x => x.QuestionTemplateId,
                        principalTable: "QuestionTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportAnswer_QuestionTemplateId",
                table: "ReportAnswer",
                column: "QuestionTemplateId");

            migrationBuilder.CreateIndex(
                name: "IX_ReportAnswer_ReportId",
                table: "ReportAnswer",
                column: "ReportId");
